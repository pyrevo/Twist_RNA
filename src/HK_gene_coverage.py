...
for gene in genes :
    ...
    for region in regions :
        ...
        print("samtools depth -d 5000000 -a -r " + region + " " + bam_file + " > " + cov_outfile_name)
        subprocess.call("samtools depth -d 5000000 -a -r " + region + " " + bam_file + " > " + cov_outfile_name, shell=True)
        time.sleep(2)
