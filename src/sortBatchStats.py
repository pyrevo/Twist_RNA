...
with open(outFile, 'w') as file:
 ##write all config for custom table
    ...
    file.write("      \"description\": \"Percent of reads mapped from Picard\",\n")
    file.write("      \"min\": 0,\n")
    file.write("      \"max\": 100,\n")
    ...
    file.write("      \"title\": \"Reads paired [%]\",\n")
    file.write("      \"description\": \"Percent reads in proper pairs from Picard\",\n")
    file.write("      \"min\": 90,\n")
    file.write("      \"max\": 100,\n")
    file.write("      \"scale\": \"RdYlGn\",\n")
    file.write("      \"suffix\": \"%\"\n")
    ...
    file.write("      \"description\": \"Percent chimeric reads from Picard\",\n")
    file.write("      \"min\": 0,\n")
    file.write("      \"max\": 1,\n")
    file.write("      \"scale\": \"RdYlGn\",\n")
    file.write("      \"suffix\": \"%\"\n")
    ...
    file.write("      \"description\": \"Percent reads with adapter sequence from Picard\",\n")
    file.write("      \"min\": 0,\n")
    file.write("      \"max\": 1,\n")
